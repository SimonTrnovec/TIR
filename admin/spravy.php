                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="../public/theme/spravy/images/<?php echo $row['obrazok'] ?>" alt="" style="width: 150px; height: 100px; float: left;"><span class="d-inline-block text-truncate" style="max-width: 500px; padding-left: 30px;"><?php echo $row['obsah'] ?></span>
                                        </td>
